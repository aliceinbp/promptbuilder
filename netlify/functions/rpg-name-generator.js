...
exports.handler = async function(event) {
  ...
  try {
    ...
    // EZ A VÉGLEGES PROMPT, KICSERÉLT PÉLDÁKKAL
    const promptText = lang === 'hu'
      ...
      A következő nevek KIZÁRÓLAG STÍLUS PÉLDÁK a minőség bemutatására: 'Lyra Valerion', 'Sorin Thale', 'Elaria Vessar'. NE HASZNÁLD VAGY MÁSOLD ezeket a neveket vagy a részeiket! A feladatod, hogy teljesen új, hasonlóan eredeti stílusú neveket alkoss.
      ...
      The following names are STYLE EXAMPLES ONLY to show the desired quality: 'Lyra Valerion', 'Sorin Thale', 'Elaria Vessar'. DO NOT USE OR COPY these specific names or their parts! Your task is to generate completely new names in a similar, original style.
