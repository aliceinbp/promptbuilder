document.addEventListener('DOMContentLoaded', function() {
    ...
    const prompts = {
        en: {
            ...
            subject: ["Half-elf woman, black wavy hair, ice-blue eyes, black noble dress, sapphire pendant, medieval", "Human woman, ash-blonde hair, emerald eyes, elegant medieval dress", "Tall elf woman, black braided hair, yellow-gold eyes, assassin warrior, expressionless, early medieval", "Brown-haired human man, brown eyes, city guard, sword, bloodied, ominous, medieval"],
            setting: ["a magical library with floating books and glowing runes", "a sun-drenched, overgrown ruin with ancient statues", "a bioluminescent cave filled with glowing fungi", "a snow-covered mountain peak with a hidden monastery", "an ornate, grand ballroom from a forgotten era, covered in dust", "a desert landscape with massive, petrified creatures", "a deep-sea trench with luminescent, bizarre marine life", "a quiet, moonlit garden with sculpted hedges", "an ancient temple carved into a giant tree", "a post-apocalyptic junkyard with overgrown vegetation", "a vibrant, impossible jungle with floating islands", "a grand, ornate throne room with shattered glass and lightbeams", "a misty, hidden village in a valley between mountains", "a vast underground cavern with giant crystals", "a chaotic wizard's laboratory with glowing potions and scrolls"],
            extra: ["detailed line work, manga style, dynamic pose", "watercolor art, soft pastel palette, ethereal feel", "pixel art, retro 8-bit aesthetic, vibrant tones", "sketch art, charcoal on paper, rough strokes", "pointillism, abstract forms, vivid dots", "geometric shapes, abstract cubism, bold colors", "stained glass art, intricate patterns, glowing light", "photorealistic, cinematic portrait, shallow depth of field", "low poly, stylized cartoon, smooth shading", "pop art, comic book style, bold lines and half-tones", "etching art, cross-hatching, old-world feel", "3D render, subsurface scattering, realistic textures", "chalk drawing, smudged edges, soft light", "woodcut art, high contrast, rustic feel", "glitch art, corrupted image effect, digital noise"]
        },
        hu: {
            style: ["Jean-Michel Basquiat + Cy Twombly, textúra és expresszív absztrakció", "Albert Bierstadt + Bob Ross, fenséges tájképek, buja részletekkel", "Hayao Miyazaki + Makoto Shinkai, vibráló, érzelmes anime látványvilág", "Alex Grey + visionary art, spirituális és transzcendens vizuális metaforák", "Greg Rutkowski + Alphonse Mucha, fantasy illusztráció, szecessziós stílusban", "Gustav Klimt + Egon Schiele, arany, minták és nyers emberi érzelmek", "Banksy + Jean-Michel Basquiat, street art, társadalmi kommentárral", "Frida Kahlo + fantasy art, szürreális önarcképek, fantasztikus elemekkel", "Rembrandt + Caravaggio, sötét, drámai portrék mesteri fény-árnyékkal", "René Magritte + M.C. Escher, gondolatébresztő, paradox valóság", "Gregory Crewdson + Boris Vallejo, mozihatású világítás, fantasy realizmus", "Boris Vallejo + Zdzisław Beksiński, hiperrealista sötét fantasy", "Malcolm Liepke + Phil Hale, expresszív ecsetkezelés, lefolyó melankólia", "Caravaggio + Annie Leibovitz, drámai portré", "Frank Frazetta + Gustave Doré, epikus fantasy illusztráció", "Salvador Dalí + Hieronymus Bosch, álomszerű szürrealizmus", "H.R. Giger + Francis Bacon, biomechanikus pszichológiai horror", "Edward Hopper + Film Noir esztétika, esőáztatta városi melankólia", "Brom + Zdzisław Beksiński, sötét fantasy, baljós karakterábrázolás", "Frank Frazetta + Greg Rutkowski, klasszikus fantasy hősök és illusztrációk", "Moebius (Jean Giraud) + Syd Mead, futurisztikus sci-fi karakterek és világok", "Akira Toriyama + Yoshitaka Amano, anime-stílusú hősök, fantáziaelemekkel", "Yoji Shinkawa + H.R. Giger, biomechanikus, poszt-apokaliptikus karakterek", "J.C. Leyendecker + Norman Rockwell, klasszikus, ikonikus kalandorok", "Tsutomu Nihei + sci-fi noir, sötét, részletgazdag cyberpunk és disztópikus karakterek", "Kentaro Miura + fantasy art, részletgazdag, epikus és brutális karakterek", "Alphonse Mucha + Art Nouveau aesthetic, elegáns, mágikus, art nouveau stílusú karakterek", "Loish + whimsical art, színes, stilizált és bájos fantasy karakterek", "Caspar David Friedrich + Disney concept art, olajfestmény, varázslatos, holdfényes erdő.", "Syd Mead + Jean-Michel Basquiat, digitális művészet, neon-futurisztikus, graffitis város.", "Edward Hopper + Ansel Adams, valósághű ábrázolás, eső áztatta vasútállomás.", "Makoto Shinkai + Hayao Miyazaki, anime stílusú, csendes mezőn futó vonat.", "Albert Bierstadt + Frank Frazetta, olajfestmény, ködös hegyi tó rejtett kristályokkal.", "Andrew Wyeth + J.M.W. Turner, akvarell, csendes, ködös tengerpart.", "Jack Kirby + Frank Miller, képregény stílusú, monumentális futurisztikus város.", "Moebius (Jean Giraud) + Studio Ghibli art, digitális művészet, lebegő sziget hatalmas fákkal.", "Edward Weston + Michael Kenna, fotórealista, fekete-fehér, elhagyatott móló.", "Claude Monet + Vincent van Gogh, impresszionista, napfelkelte a mező felett."],
            subject: ["Félelf nő, fekete hullámos haj, jégkék szemek, fekete nemesi ruha, zafír medál, középkori", "Ember nő, hamvasszőke haj, smaragdzöld szemek, elegáns középkori ruha", "Magas elf nő, fekete fonott haj, arany-sárga szemek, orgyilkos harcos, érzelemmentes, kora középkori", "Barna hajú ember férfi, barna szemek, városi őr, kard, véres, baljós, középkori"],
            setting: ["egy mágikus könyvtár lebegő könyvekkel és fénylő rúnákkal", "egy napfényes, benőtt rom ősi szobrokkal", "egy biolumineszcens barlang tele izzó gombákkal", "egy hófedte hegycsúcs egy rejtett kolostorral", "egy díszes, nagy bálterem egy elfeledett korból, por borítja", "egy sivatagi táj hatalmas, megkövesedett lényekkel", "egy mélytengeri árok fénylő, bizarr tengeri élőlényekkel", "egy csendes, holdfényes kert formára nyírt sövényekkel", "egy ősi templom, amelyet egy óriási fába vájtak", "egy poszt-apokaliptikus roncstelep, amelyet benőtt a növényzet", "egy vibráló, lehetetlen dzsungel lebegő szigetekkel", "egy díszes, nagy trónterem összetört üveggel és fénysugarakkal", "egy ködös, rejtett falu egy völgyben a hegyek között", "egy hatalmas földalatti barlang óriási kristályokkal", "egy kaotikus varázsló laboratóriuma izzó bájitalokkal és tekercsekkel"],
            extra: ["részletes vonalvezetés, manga stílus, dinamikus póz", "akvarell, lágy pasztell paletta, éteri hangulat", "pixel art, retro 8-bites esztétika, élénk tónusok", "vázlat, szénrajz papíron, durva vonások", "pointillizmus, absztrakt formák, élénk pontok", "geometrikus formák, absztrakt kubizmus, merész színek", "ólomüveg művészet, bonyolult minták, izzó fény", "fotorealisztikus, filmszerű portré, sekély mélységélesség", "low poly, stilizált rajzfilm, sima árnyékolás", "pop art, képregény stílus, merész vonalak és féltónusok", "rézkarc, kereszt-satírozás, régi vágású hangulat", "3D render, subsurface scattering, valósághű textúrák", "krétarajz, elmosódott élek, lágy fény", "fametszet, magas kontraszt, rusztikus hangulat", "glitch art, sérült kép effektus, digitális zaj"]
        }
    };
