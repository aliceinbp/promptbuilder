...
document.addEventListener('DOMContentLoaded', function() {
    ...
    async function loadSinglePost() {
        ...
        try {
            ...
            container.innerHTML = `<div class="post-header"><h1>${title}</h1><p class="post-meta">${translations[currentLanguage].postedOn} ${postDate}</p></div><img src="${frontmatter.image}" alt="${title}" class="post-featured-image"><div class="post-body">${bodyHtml}</div>${likeBtnHtml}`;
