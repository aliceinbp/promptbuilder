// ===== Alkimista Műhely - Adatbetöltő Szkript (data-loaders.js) - JAVÍTOTT =====
...
                                <button class="cta-button-small copy-prompt-btn" data-prompt="${promptText}" data-key="copyButton"></button>
                            </div>
                        </div>
                    </a>`;
...
        const promptIndex = (dayOfYear - 1 + prompts.length) % prompts.length;
...
                
                setTimeout(() => {
                    buttonTextSpan.textContent = translations[lang].copyButton;
